...
class RolloutStorage(object):
    ...
    def feed_forward_generator(self, advantages, num_mini_batch):
        ...
        assert batch_size >= num_mini_batch, (
            ...
            "to be greater than or equal to the number of PPO mini batches ({num_mini_batch}).".format(num_processes, num_steps, num_processes * num_steps, num_mini_batch))
    ...
    def recurrent_generator(self, advantages, num_mini_batch):
        ...
        assert num_processes >= num_mini_batch, (
            "PPO requires the number processes ({num_processes}) "
            "to be greater than or equal to the number of PPO mini batches ({num_mini_batch}).".format(num_processes, num_mini_batch))
